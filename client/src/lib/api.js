...
export const api = {
  ...
  updateActivity: (activity) => request('/api/account/activity', { method: 'PUT', body: JSON.stringify(activity) }),
  clearActivity: () => request('/api/account/activity', { method: 'DELETE' }),
  joinActivity: (userId) => request(`/api/social/users/${userId}/activity/join`, { method: 'POST' }),
  ...
  developerInstallInfo: (id) => request(`/api/developer/apps/${id}/install`),
  authorizeDeveloperApp: (id, data) => request(`/api/developer/apps/${id}/authorize`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  guildBots: (guildId) => request(`/api/developer/guilds/${guildId}/bots`),
  removeGuildBot: (guildId, appId) => request(`/api/developer/guilds/${guildId}/bots/${appId}`, { method: 'DELETE' }),
  invokeGuildCommand: (guildId, appId, name, data) => request(`/api/developer/guilds/${guildId}/commands/${appId ? `${appId}/` : ''}${encodeURIComponent(name)}/invoke`, { method: 'POST', body: JSON.stringify(data) }),
