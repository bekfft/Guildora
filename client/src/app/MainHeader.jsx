  ...
  return (
    <header className="main-header">
      ...
      <div className="main-header__actions">
        <button className="icon-button header-threads" type="button" aria-label="Threads" onClick={() => onToast('Threads folgen in einer späteren Version.')}><ListTree size={20} /></button>
        ...
        <button className="icon-button header-pins" type="button" aria-label="Pinnwand" onClick={() => onToast('Die Pinnwand folgt später.')}><Pin size={20} /></button>
        ...
        <button className="icon-button header-help" type="button" aria-label="Hilfe" onClick={() => onToast('Das Hilfe-Center wird vorbereitet.')}><HelpCircle size={20} /></button>
      </div>
    </header>
  );
}
